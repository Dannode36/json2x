...
{
    { "java", { "int", "float", "int", "long", "long", "double", "String", "bool", "empty", "{0} {1};", "ArrayList<{0}> {1};", "class {}\n{{\n", "}\n", "", "", L".java" } },
    { "kotlin", { "int", "float", "UInt", "long", "ULong", "double", "String", "bool", "empty", "{0} {1};", "List<{0}> {1};", "class {}\n{{\n", "}\n", "", "", L".kt" } },
    { "cpp", { "int", "float", "unsigned int", "long long", "unsigned long long", "double", "std::string", "bool", "void*", "{0} {1};", "std::vector<{0}> {1};", "struct {} {{\n", "};\n", "#include <vector>\n", "#include <string>\n", L".h" } },
    { "csharp", { "int", "float", "uint", "long", "ulong", "double", "string", "bool", "empty", "{0} {1};", "List<{0} {1};>", "class {}\n{{\n", "}\n", "using System.Collections.Generic;\n", "", L".cs" } },
    { "rust", { "i32", "f32", "u32", "i64", "u64", "f64", "String", "bool", "empty", "{1}: {0},", "Vec<{0}> {1};", "struct {}\n{{\n", "}\n", "", "", L".rs" } },
};
